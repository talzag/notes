...
<head>
    ...
    <meta name="keywords" content="note,notes,take notes,blank page to type on,blank page,blank slate">
...
<!-- TOP STATUS BAR WITH BUTTONS -->
    <div class="note-container">
        <div class="status-bar" contenteditable="false">
            <a class="close"></a><a href="/" class="top-left"><span class="message">+ blank slate</span><span class="sharing"><span id="share-url" class="share-url"></span></span></a>
            ...
            <a class="round-button full-round-button publish-note" data-clipboard-target="#share-url">share note</a>
...
<!-- VARIOUS OVERLAYS/POPINS FOR LOGGING IN, SIGNING UP, LEARNING MORE, ETC. -->
        ...
        <div id="choose-user-type" class="popin" contenteditable="false">
            ...
            <ul class="popin-list">
                ...
                <li><a class="round-button semi-round-button permanent-user">signup for permanent user</a><a class="round-button semi-round-button guest-user">continue as guest</a></li>
            </ul>
        </div>
